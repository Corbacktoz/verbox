...
await writeFile(new URL('_headers',output),'/*\n  X-Content-Type-Options: nosniff\n  X-Frame-Options: DENY\n  Referrer-Policy: strict-origin-when-cross-origin\n  Strict-Transport-Security: max-age=63072000; includeSubDomains; preload\n  Permissions-Policy: camera=(), microphone=(), geolocation=(), payment=(), usb=()\n  Content-Security-Policy: default-src \'self\'; script-src \'self\' https://cdn.matomo.cloud; style-src \'self\' \'unsafe-inline\'; img-src \'self\' data: https://verbox.matomo.cloud; connect-src \'self\' https://verbox.matomo.cloud; font-src \'self\'; object-src \'none\'; base-uri \'self\'; form-action \'self\'; frame-ancestors \'none\';\n/progres/*\n  X-Robots-Tag: noindex, follow\n/404.html\n  X-Robots-Tag: noindex, follow\n');
